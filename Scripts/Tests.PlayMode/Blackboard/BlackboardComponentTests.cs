...
namespace HiraBots.Editor.Tests
{
    ...
    internal class BlackboardComponentTests : BlackboardAccessTestBase
    {
        ...
        public void CreationValidation()
        {
            ...
            BlackboardComponent component = null;

            try
            {
                Assert.IsTrue(!TryCreate((BlackboardTemplateCompiledData) null, out component) && component == null,
                    "Created a component without template.");

                Assert.IsTrue(!TryCreate(nonCompilingBlackboard.compiledData, out component) && component == null,
                    "Created a component with a non-compiling template.");

                Assert.IsTrue(TryCreate(m_BaseCharacterTemplate.compiledData, out component) && component != null,
                    "Failed to create a base character.");

                component.Dispose();
                component = null;

                Assert.IsTrue(TryCreate(m_WarriorTemplate.compiledData, out component) && component != null,
                    "Failed to create a warrior character.");

                component.Dispose();
                component = null;

                Assert.IsTrue(TryCreate(m_MageTemplate.compiledData, out component) && component != null,
                    "Failed to create a mage character.");

                component.Dispose();
                component = null;

                Assert.IsTrue(TryCreate(m_ElementalistTemplate.compiledData, out component) && component != null,
        ...
        public void SimpleReadWriteValidation()
        {
            ...
            TryCreate(m_ElementalistTemplate.compiledData, out var secondBaboon);
            ...
            TryCreate(m_WarriorTemplate.compiledData, out var knight);
            ...
            TryCreate(m_MageTemplate.compiledData, out var wizard);
        ...
        {
            TryCreate(m_BaseCharacterTemplate.compiledData, out var civilian);
