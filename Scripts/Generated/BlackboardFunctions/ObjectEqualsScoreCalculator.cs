...
namespace UnityEngine.AI
{
    ...
    public unsafe partial class ObjectEqualsScoreCalculator : HiraBotsScoreCalculatorBlackboardFunction
    {
        ...
        { _invert = invert, _key = key.selectedKey.offset, _value = GeneratedBlackboardHelpers.ObjectToInstanceID(value), _score = score };
        ...
        private static float ActualFunction(in BlackboardComponent.LowLevel blackboard, byte* rawMemory, float currentScore)
        {
            ...
            return HiraBots.SampleScoreCalculatorBlackboardFunctions.ObjectEqualsScoreCalculator(currentScore, memory->_invert, ref blackboard.Access<int>(memory->_key), memory->_value, memory->_score);
        }
