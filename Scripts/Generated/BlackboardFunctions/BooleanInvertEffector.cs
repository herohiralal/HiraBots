...
namespace UnityEngine.AI
{
    ...
    public unsafe partial class BooleanInvertEffector : HiraBotsEffectorBlackboardFunction
    {
        ...
        private static void ActualFunction(in BlackboardComponent.LowLevel blackboard, byte* rawMemory)
        {
            ...
            HiraBots.SampleEffectorBlackboardFunctions.BooleanInvertEffector(ref blackboard.Access<bool>(memory->_key));
        }

        // non-VM execution
        protected override void ExecuteFunction(BlackboardComponent blackboard, bool expected)
        {
            var _key = blackboard.GetBooleanValue(key.selectedKey.name); HiraBots.SampleEffectorBlackboardFunctions.BooleanInvertEffector(ref _key); blackboard.SetBooleanValue(key.selectedKey.name, _key, expected);
        }
        ...
        {
            HiraBots.SampleEffectorBlackboardFunctions.BooleanInvertEffectorUpdateDescription(key, out staticDescription);
        }
