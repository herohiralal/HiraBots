...
namespace UnityEngine.AI
{
    ...
    public unsafe partial class EnumEqualsScoreCalculator : HiraBotsScoreCalculatorBlackboardFunction
    {
        ...
        private static float ActualFunction(in BlackboardComponent.LowLevel blackboard, byte* rawMemory, float currentScore)
        {
            ...
            return HiraBots.SampleScoreCalculatorBlackboardFunctions.EnumEqualsScoreCalculator(currentScore, memory->_invert, ref blackboard.Access<byte>(memory->_key), memory->_value, memory->_score);
        }
        ...
        {
            HiraBots.SampleScoreCalculatorBlackboardFunctions.EnumEqualsScoreCalculatorUpdateDescription(invert, key, value, score, out staticDescription);
        }
