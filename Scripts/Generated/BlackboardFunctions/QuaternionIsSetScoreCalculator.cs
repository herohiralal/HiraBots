...
namespace UnityEngine.AI
{
    ...
    public unsafe partial class QuaternionIsSetScoreCalculator : HiraBotsScoreCalculatorBlackboardFunction
    {
        ...
        private static float ActualFunction(in BlackboardComponent.LowLevel blackboard, byte* rawMemory, float currentScore)
        {
            ...
            return HiraBots.SampleScoreCalculatorBlackboardFunctions.QuaternionIsSetScoreCalculator(currentScore, memory->_invert, ref blackboard.Access<Unity.Mathematics.quaternion>(memory->_key), memory->_score);
        }
        ...
        {
            key.keyTypesFilter = UnityEngine.AI.BlackboardKeyType.Invalid | UnityEngine.AI.BlackboardKeyType.Quaternion;
            // no external validator
        }

        protected override void UpdateDescription(out string staticDescription)
        {
            HiraBots.SampleScoreCalculatorBlackboardFunctions.QuaternionIsSetScoreCalculatorUpdateDescription(invert, key, score, out staticDescription);
        }
        ...
        public override void Validate(ref ValidatorContext context)
        {
            ...
            ValidateKeySelector(ref key, UnityEngine.AI.BlackboardKeyType.Invalid | UnityEngine.AI.BlackboardKeyType.Quaternion, ref context, nameof(key));
        }
