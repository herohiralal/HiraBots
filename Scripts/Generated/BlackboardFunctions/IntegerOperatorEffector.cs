...
namespace UnityEngine.AI
{
    ...
    public unsafe partial class IntegerOperatorEffector : HiraBotsEffectorBlackboardFunction
    {
        private struct Memory
        {
            ...
            internal HiraBots.SampleBlackboardFunctionsIntegerOperationType _operationType;
            internal System.Int32 _value;
        }

        [SerializeField] internal BlackboardTemplate.KeySelector key;
        [SerializeField] internal HiraBots.SampleBlackboardFunctionsIntegerOperationType operationType;
        ...
        private static void ActualFunction(in BlackboardComponent.LowLevel blackboard, byte* rawMemory)
        {
            ...
            HiraBots.SampleEffectorBlackboardFunctions.IntegerOperatorEffector(ref blackboard.Access<int>(memory->_key), memory->_operationType, memory->_value);
        }
        ...
        {
            key.keyTypesFilter = UnityEngine.AI.BlackboardKeyType.Invalid | UnityEngine.AI.BlackboardKeyType.Integer;
        ...
        {
            HiraBots.SampleEffectorBlackboardFunctions.IntegerOperatorEffectorUpdateDescription(key, operationType, value, out staticDescription);
        }
        ...
        public override void Validate(ref ValidatorContext context)
        {
            ...
            ValidateKeySelector(ref key, UnityEngine.AI.BlackboardKeyType.Invalid | UnityEngine.AI.BlackboardKeyType.Integer, ref context, nameof(key));
        }
