...
namespace UnityEngine
{
    public unsafe partial class EnumEqualsScoreCalculator : HiraBotsScoreCalculatorBlackboardFunction
    {
        ...
        private static float ActualFunction(in BlackboardComponent.LowLevel blackboard, byte* rawMemory, float currentScore)
        {
            ...
            return HiraBots.SampleScoreCalculatorBlackboardFunctions.EnumEqualsScoreCalculator(currentScore, ref blackboard.Access<byte>(memory->_key.offset), memory->_value, memory->_score);
        }

        // non-VM execution
        protected override float ExecuteFunction(BlackboardComponent blackboard, bool expected, float currentScore)
        {
            var _key = blackboard.GetEnumValue(key.selectedKey.name); var output = HiraBots.SampleScoreCalculatorBlackboardFunctions.EnumEqualsScoreCalculator(currentScore, ref _key, value, score); return output;
        }
