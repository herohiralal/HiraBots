...
{
    public unsafe partial class QuaternionIsSetEffector : HiraBotsEffectorBlackboardFunction
    {
        ...
        private static void ActualFunction(in BlackboardComponent.LowLevel blackboard, byte* rawMemory)
        {
            ...
            HiraBots.SampleEffectorBlackboardFunctions.QuaternionIsSetEffector(ref blackboard.Access<Unity.Mathematics.quaternion>(memory->_key.offset), memory->_operationType);
        }

        // non-VM execution
        protected override void ExecuteFunction(BlackboardComponent blackboard, bool expected)
        {
            var _key = blackboard.GetQuaternionValue(key.selectedKey.name); HiraBots.SampleEffectorBlackboardFunctions.QuaternionIsSetEffector(ref _key, operationType); blackboard.SetQuaternionValue(key.selectedKey.name, _key, expected);
        }
